...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Memory_dispose<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
) {
    wrap_error!(
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Memory_nativeBuffer__J<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
    store_ptr: jlong,
) -> jobject {
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Memory_nativeDataSize__J<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
    store_ptr: jlong,
) -> jlong {
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Memory_nativeGrow__JJ<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
    store_ptr: jlong,
    delta_pages: jlong,
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Memory_nativeSize__J<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
    store_ptr: jlong,
) -> jint {
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Memory_newMemory__JJJZ<'a>(
    mut env: JNIEnv<'a>,
    clazz: JClass<'a>,
    inner_ptr: jlong,
    minimum: jlong,
