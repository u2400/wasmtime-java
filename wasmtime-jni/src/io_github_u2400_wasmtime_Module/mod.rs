...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Module_dispose<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
) {
    wrap_error!(
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Module_imports<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
) -> jobjectArray {
    wrap_error!(
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Module_newFromBinary__J_3B<'a>(
    mut env: JNIEnv<'a>,
    clazz: JClass<'a>,
    engine_ptr: jlong,
    bytes: jbyteArray,
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Module_newFromFile__JLjava_lang_String_2<'a>(
    mut env: JNIEnv<'a>,
    clazz: JClass<'a>,
    engine_ptr: jlong,
    file_name: JString<'a>,
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Module_newModule__J_3B<'a>(
    mut env: JNIEnv<'a>,
    clazz: JClass<'a>,
    engine_ptr: jlong,
    bytes: jbyteArray,
