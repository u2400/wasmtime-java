...
pub const IMPORT_TYPE_CLASS: &'static str = "io/github/u2400/wasmtime/ImportType$Type";
...
impl<'a> JniModule<'a> for JniModuleImpl {
    ...
    fn imports(
        ...
        const IMPORT_TYPE: &str = "io/github/u2400/wasmtime/ImportType";
            ...
            let (ty, ty_obj) = match obj.ty() {
                ExternType::Func(func) => {
                    ...
                    (
                        ...
                        env.new_object(
                            "io/github/u2400/wasmtime/FuncType",
                ...
                ExternType::Global(global) => {
                    ...
                    (
                        ...
                        env.new_object(
                            "io/github/u2400/wasmtime/GlobalType",
                ...
                ExternType::Table(tab) => {
                    const TABLE_TYPE: &str = "io/github/u2400/wasmtime/TableType";
                ...
                ExternType::Memory(mem) => {
                    const MEMORY_TYPE: &str = "io/github/u2400/wasmtime/MemoryType";
