...
impl<'a> JniFunc<'a> for JniFuncImpl {
    ...
    fn new_func(
        ...
        let param_types_objs = env
            .get_field(&fn_type, "params", "[Lio/github/u2400/wasmtime/Val$Type;")?
            .l()?
            .into_raw();
        let param_types = wval::types_from_java(env, param_types_objs)?.into_boxed_slice();
        let result_type_objs = env
            .get_field(&fn_type, "results", "[Lio/github/u2400/wasmtime/Val$Type;")?
            .l()?
            .into_raw();
    ...
    fn native_call(
        ...
        utils::into_java_array(env, "io/github/u2400/wasmtime/Val", java_results)
    }
...
fn invoke_trampoline<'a, T>(
    ...
    let jparam_values = params
        ...
        .collect::<Result<Vec<_>, _>>()?;
    let jparams = utils::into_java_array(&mut env, "io/github/u2400/wasmtime/Val", jparam_values)?;
    ...
    let call_result = env.call_static_method(
        "io/github/u2400/wasmtime/Func",
        "invokeTrampoline",
        "(JI[Lio/github/u2400/wasmtime/Val;[Lio/github/u2400/wasmtime/Val;)V",
        &[
            caller_ptr.into(),
            index.into(),
