...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Func_dispose<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
) {
    wrap_error!(
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Func_nativeCall__J_3Lio_github_u2400_wasmtime_Val_2<
    'a,
>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Func_newFunc__JLio_github_u2400_wasmtime_FuncType_2I<
    'a,
>(
    mut env: JNIEnv<'a>,
    clazz: JClass<'a>,
