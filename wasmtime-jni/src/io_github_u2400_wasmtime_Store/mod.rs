...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Store_dispose<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
) {
    wrap_error!(
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Store_enginePtr<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
) -> jlong {
    wrap_error!(
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Store_gc<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
) {
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Store_newStore__JLjava_lang_Object_2J<'a>(
    mut env: JNIEnv<'a>,
    clazz: JClass<'a>,
    engine_ptr: jlong,
    data: JObject<'a>,
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Store_setEpochDeadline__J<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
    ticks_beyond_current: jlong,
) {
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Store_storedData<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
) -> jobject {
    wrap_error!(
