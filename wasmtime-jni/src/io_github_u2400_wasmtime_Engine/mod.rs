...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Engine_dispose<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
) {
    wrap_error!(
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Engine_incrementEpoch<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
) {
    wrap_error!(
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Engine_newEngine<'a>(
    mut env: JNIEnv<'a>,
    clazz: JClass<'a>,
) -> jlong {
    wrap_error!(
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Engine_newEngineWithConfig__Lio_github_u2400_wasmtime_Config_2<
    'a,
>(
    mut env: JNIEnv<'a>,
    clazz: JClass<'a>,
