...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Global_dispose<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
) {
    wrap_error!(
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Global_nativeGet__J<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
    store_ptr: jlong,
) -> jobject {
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Global_nativeMutable__J<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
    store_ptr: jlong,
) -> jboolean {
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Global_nativeSet__JLio_github_u2400_wasmtime_Val_2<
    'a,
>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
