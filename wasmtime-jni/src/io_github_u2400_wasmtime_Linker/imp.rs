    ...
    fn native_externs(
        ...
        for (module, name, ext) in externs {
            ...
            let extern_item = env.new_object(
                "io/github/u2400/wasmtime/ExternItem",
                "(Ljava/lang/String;Ljava/lang/String;Lio/github/u2400/wasmtime/Extern;)V",
                &[
        ...
        Ok(utils::into_java_array(env, "io/github/u2400/wasmtime/ExternItem", objs)?.into())
    }
