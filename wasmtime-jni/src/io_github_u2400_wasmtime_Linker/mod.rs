...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Linker_dispose<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
) {
    wrap_error!(
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Linker_nativeDefine__JLjava_lang_String_2Ljava_lang_String_2Lio_github_u2400_wasmtime_Extern_2<
    'a,
>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Linker_nativeExterns__J<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
    store_ptr: jlong,
) -> jobjectArray {
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Linker_nativeGet__JLjava_lang_String_2Ljava_lang_String_2<
    'a,
>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Linker_nativeModule__JLjava_lang_String_2J<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
    store_ptr: jlong,
    module_name: JString<'a>,
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Linker_newLinker__J<'a>(
    mut env: JNIEnv<'a>,
    clazz: JClass<'a>,
    engine_ptr: jlong,
) -> jlong {
