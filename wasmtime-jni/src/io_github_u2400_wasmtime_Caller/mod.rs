...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Caller_data<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
) -> jobject {
    wrap_error!(
...
#[no_mangle]
extern "system" fn Java_io_github_u2400_wasmtime_Caller_nativeGetExport__Ljava_lang_String_2<'a>(
    mut env: JNIEnv<'a>,
    this: JObject<'a>,
    name: JString<'a>,
) -> jobject {
